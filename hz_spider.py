...
def get_data():
    ...
    for y in y_list:
        for p in range(1, 100):
            ...
            url = 'https://hangzhou.anjuke.com/sale/p' + str(p) + '-y' + y + '/?from=fangjia'
            print(url)
            driver.get(url)
            time.sleep(3)
            ...
            for sl in soup_list:
                ...
                print(data)
                with open('C:\\Users\\14650\\OneDrive\\Desktop\\mypra\\data\\data.json', 'a', encoding='utf8') as f:
                    f.write(json.dumps(data, ensure_ascii=False) + ',\n')
                data_list.append(data)
            print(p)

    df = pd.DataFrame(data_list)
    df.to_excel('C:\\Users\\14650\\OneDrive\\Desktop\\mypra\\data\\data.xlsx', index=False)
